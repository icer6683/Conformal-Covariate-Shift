...
USAGE:
  ...
  # Then run:
  python finance_conformal.py --npz sp500_20240101_20240301.npz
  python finance_conformal.py --npz sp500_20240101_20240301.npz --sector Technology
  python finance_conformal.py --npz sp500_20240101_20240301.npz --alpha 0.05
...
def run_finance_experiment(
    ...
    train_frac   : fraction of tickers used to fit the linear model
