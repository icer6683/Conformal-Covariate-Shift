...
-----------
  ...
  python finance-data.py --pull

  # Pull a small test batch of 10 stocks:
  python finance-data.py --pull --top_n 10

  # Load saved data and print a summary:
  python finance-data.py --summary

  # Load saved data and filter to Technology sector:
  python finance-data.py --summary --sector Technology

  # Load saved data and filter to Semiconductors industry:
  python finance-data.py --summary --industry Semiconductors

  # List all sectors in saved data:
  python finance-data.py --list_sectors

  # List all industries in saved data:
  python finance-data.py --list_industries
