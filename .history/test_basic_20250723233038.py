...
def run_online_coverage_experiment(generator, predictor, n_timesteps=500, ar_coef=0.7, noise_std=0.2, 
    ...
    if with_shift:
        ...
        original_long = generator.generate_ar_process(n=1, ar_coef=ar_coef, noise_std=noise_std, T=n_timesteps-1)[0]
        ...
        long_series = generator.generate_ar_process(n=1, ar_coef=ar_coef, noise_std=noise_std, T=n_timesteps-1)[0]
