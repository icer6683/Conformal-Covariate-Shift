...
def plot_results(results, save_path=None):
    ...
    axes[0].axhline(target, color='red', linestyle='--', linewidth=2, label=f'Target ({target:.0%})')
    ...
    axes[2].fill_between(x, first["lower"], first["upper"], alpha=0.25, color='steelblue', label='Prediction interval')
    ...
    axes[3].plot(x, gammas, drawstyle='steps-post', color='purple', linewidth=1.5)
    axes[3].set_ylabel('Selected gamma (log scale)')
    axes[3].set_title('ACI Gamma Selected over Time')
