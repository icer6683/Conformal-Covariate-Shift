...
QUICK START
-----------
  python yfinance_loader.py --pull                                  # Pull all ~500 S&P 500 stocks (Jan-Mar 2024) and save to disk
  python yfinance_loader.py --pull --top_n 10                       # Quick test: pull only the first 10 stocks (~30 seconds)
  python yfinance_loader.py --summary                               # Load saved data and print a full summary
  python yfinance_loader.py --summary --sector Technology           # Summary filtered to Technology sector only
  python yfinance_loader.py --summary --industry Semiconductors     # Summary filtered to Semiconductors industry only
  python yfinance_loader.py --list_sectors                          # List all sectors present in saved data
  python yfinance_loader.py --list_industries                       # List all industries present in saved data
