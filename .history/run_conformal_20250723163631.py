...
"""
=============================================================================
RUN_CONFORMAL.PY - COMPLETE CONFORMAL PREDICTION EXPERIMENT
=============================================================================
...
DEFAULT VALUES:
- n_train=200 (training series)
- n_test=30 (test series)  
- T=25 (time series length)
- alpha=0.1 (10% miscoverage, 90% target coverage)
- shift_time=12 (covariate shift occurs at t=12)
- shift_amount=2.0 (magnitude of shift)
- seed=42 (reproducible results)

USAGE:
  python run_conformal.py                              # Use all defaults
  python run_conformal.py --n_test 100 --alpha 0.05   # Custom parameters
  python run_conformal.py --save_plot                  # Save comparison plots
  python run_conformal.py --shift_time 0 --T 30       # Shift from beginning
=============================================================================
"""
