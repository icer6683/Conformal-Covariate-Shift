...
def main():
    ...
    parser.add_argument('--T', type=int, default=30, help='Time series length (T+1 points)')
    parser.add_argument('--seed', type=int, default=100, help='Random seed')

    # Y model params
    parser.add_argument('--ar_coef', type=float, default=1.001, help='AR(1) coefficient for Y')
