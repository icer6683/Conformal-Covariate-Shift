...
-------------------
  ...
  DailyRangeReturn_lag1  lagged 1    (High - Low)_{t-1} / Close_{t-1}
...
def _build_covariates(df: pd.DataFrame, extra: bool,
    ...
    DailyRangeReturn_lag1  : (High - Low)_{t-1} / Close_{t-1}  volatility proxy  [lagged 1]
    """
    ...
    if extra:
        ...
        cov["DailyRangeReturn_lag1"] = daily_range / prev
