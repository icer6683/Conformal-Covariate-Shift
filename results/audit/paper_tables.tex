...
settings.  The search grid is finer to accommodate the larger residual
scale of NaCl dosing,
$\Gamma = \{10^{-6}, 5{\cdot}10^{-6}, 10^{-5}, 5{\cdot}10^{-5},
10^{-4}, 5{\cdot}10^{-4}, 10^{-3}, 5{\cdot}10^{-3}, 10^{-2}\}$,
and $\gamma$ is reselected every 5 steps.
...
\caption{%
  ...
  $\{10^{-6}, 5{\cdot}10^{-6}, 10^{-5}, 5{\cdot}10^{-5}, 10^{-4},
    5{\cdot}10^{-4}, 10^{-3}, 5{\cdot}10^{-3}, 10^{-2}\}$
  and is reselected every 5 steps.
}
\label{tab:medical}
\begin{tabular}{@{} l l S[table-format=1.3] S[table-format=1.3] S[table-format=3.2] @{}}
\toprule
\textbf{Data condition} & \textbf{Algorithm}
  & \textbf{Coverage} & $\boldsymbol{\overline{|\Delta|}}$ & \textbf{Width} \\
\midrule
\multirow{3}{*}{Norepinephrine shift}
